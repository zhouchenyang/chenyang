...
sudo airodump-ng --band abg  --bssid C4:E9:84:10:6B:DF --write $EasyAP/logs/beacons.cap mon0
#sudo airodump-ng --band abg --beacons --bssid C4:E9:84:10:52:DF --write $EasyAP/logs/frames.cap mon0
#sudo airodump-ng --band abg --beacons mon0
